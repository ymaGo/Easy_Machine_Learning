...
# display sample datas at two dimensional coordinate
...
# generate sample data, there are 3 cluster in total
mc = [0.4, 0.4, 0.2]
...
# display the un-clustered data by plot_results
...
# seperate the sample data in to 3 clusters by GMM of EM and displayed by different color in two dimensional coordinate
